#!/usr/bin/env python3
"""
MCP Client Simulator for testing the Redmine MCP server
This script simulates MCP client requests to test the Redmine MCP server
"""
        ...
        create_issue_request = {
            ...
            "params": {
                ...
                "arguments": {
                    ...
                    "description": "This is a test issue created via the MCP protocol."
                }
            }
        }
